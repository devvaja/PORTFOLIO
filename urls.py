...
urlpatterns = [
    ...
    path('menuispote2/', views.menuispote2),
    ...
    path('productDetails/<int:id>/', views.productDetails,name='product-details'),
    path('deleteProduct/<int:wishlist_item_id>/', views.deleteProduct, name='delete_wishlist_item'),
